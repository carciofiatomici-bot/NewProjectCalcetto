...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleSaveFormation = async () => {
        ...
        try {
            ...
            if (window.currentTeamData) {
                 window.currentTeamData.formation = currentTeamData.formation;
            }
    ...
    squadraBackButton.addEventListener('click', () => {
        ...
        if (window.showScreen && appContent) {
            ...
            if (window.loadDashboard) { // Assicurati che la Dashboard si aggiorni
                 window.loadDashboard(currentTeamId);
            }
        }
    });
